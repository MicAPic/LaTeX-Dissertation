...
\subsection{О связи гиперссылочной структуры сайта с его основной тематикой}\label{subsec:ch1/sec4/sub3}

\paragraph{1. Введение.} Как известно, ранжирование веб-ресурсов различными поисковыми системами и рейтинги (например, Webometrics \cite{RankingWeb}) определяются качеством контента гиперссылочной структурой и активностью пользователей на сайте.

Исследованию структуры сайтов посвящено много работ. Рассматривая структуру сайта, естественно различать внешние и внутренние гиперссылки. К внешним относятся ссылки со стороны исследуемого сайта на внешние сайты и обратно. Внутренние ссылки "--- это ссылки со страниц исследуемого сайта на его же страницы. Закономерности, связанные с внешними ссылками, например, в работах \cite{BlekanovSergeevKlemeshov,ThelwallWilkinsonMusgrove,BlekanovSergeevMaksimovBOWTIE,BlekanovSergeevMaksimov2016,BlekanovMoskalets}, с внутренними "--- в работах \cite{KenekayoroBuckleyThelwall,Pechnikov2015,Thelwall,ThelwallZuccala,PechnikovNwohiri}.

Данная работа посвящена исследованию связи внутренней гиперссылочной структуры сайт с основной направленностью его контента. В работах \cite{BlekanovSergeevKlemeshov,BlekanovSergeevMaksimov2016} на большом количестве экспериментальных данных показано наличие степенной зависимости числа собранных поисковым роботом веб-страниц сайта от числа собранных ссылок:

\[
v = \alpha n^\beta,
\]

где \(n\) "--- количество гиперссылок на определенном этапе сбора, \(v\) "--- объем множества уникальных ссылок, что эквивалентно количеству веб-страниц, \(\alpha, \beta\) "--- параметры, определяемые эмпирически.

В работе \cite{BlekanovSergeevMaksimov2016} выдвинута гипотеза о связи параметра \(\beta\) сайта с его основной тематикой. Проверке этой гипотезы посвящена данная статья. Если гипотеза подтвердится, то станет возможным определять основную тематику сайта на основании исследований его внутренней структуры, не прибегая к исследованию контента (даже без определения языка документа), что даст ряд несомненных преимуществ.

\paragraph{2. Эксперимент.} Поставлен эксперимент, в котором проверялась возможность применения параметра \(\beta\) степенной функции для кластеризации сайтов научно-учебных подразделений различных университетов. В качестве объектов эксперимента выступают сайты научно-учебных подразделений ряда ведущих российских университетов: Санкт-Петербургский государственный университет, Московский государственный университет, Высшая школа экономики, Уральский федеральный университет, Томский государственный университет. Названный университеты в сумме насчитывают 68 научно-учебных подразделений. В силу ряда технических причин (защищенность от поисковых роботов, дефектность некоторых сайтов и т. п.) были отобраны 38 сайтов (см. таблицу~\cref{tab:departmentSitesResearchResults}).

\begin{longtblr}[
	caption = {Результаты исследований сайтов подразделений},
	label = {tab:departmentSitesResearchResults},
	]{
		colspec = {XXXX}, 
		width = 1.0\linewidth,
		rowhead = 1,
	...
	\toprule
	Подразделение & Сайт & Параметр & \makecell[c]{Менее 5000\\гиперссылок}\\
	\hline
	Мат. и комп. науки (УФУ) & imkn.urfu.ru & 0,13895445 & \checkmark\\
	Политология (СПбГУ) & politology.spbu.ru & 0,23070328 &\\
	Филологический (ВШЭ) & philology.hse.ru & 0,37967944 & \checkmark\\
	Экономический (МГУ) & econ.msu.ru & 0,36471105 &\\
	Радиоэлектроника (УФУ) & rtf.urfu.ru & 0,37494412 &\\
	Гос. управление (МГУ) & spa.msu.ru & 0,38630083 &\\
	Международных отношений (ТГУ) & dir.tsu.ru & 0,39907148 &\\
	В. инж. школа (УФУ) & hse.edu.urfu.ru & 0,40382472 &\\
	Физико-техн. (ТГУ) & ftf.tsu.ru & 0,4422824 & \checkmark\\
	Восточный (СПбГУ) & orient.spbu.ru & 0,46012452 & \checkmark \\
	Исторический (ВШЭ) & hist.hse.ru & 0,5106529 &\\
	Филологиечский (ТГУ) & philology.tsu.ru & 0,5208593 &\\
	Иностр. языков (МГУ) & fil. msu.ru & 0,5229387 &\\
	Искусств (МГУ) & arts.msu.ru & 0,5240312 &\\
	Лингвистики (ВШЭ) & ling.hse.ru & 0,52746964 &\\
	Филологический (СПбГУ) & phil.spbu.ru & 0,53078467 &\\
	Экономический (ВШЭ) & economics.hse.ru & 0,55169505 & \checkmark\\
	Социологический (МГУ) & socio.msu & 0,55998117 & \checkmark\\
	П. мат. и киберн. (ТГУ) & fpmk.tsu.ru & 0,567043 & \checkmark\\
	Соц. и полит. наук (УФУ) & ispn.urfu.ru & 0,568136 &\\
	Исторический (СПбГУ) & history.spbu.ru & 0,57104033 &\\
	Юридический (СПбГУ) & law.spbu.ru & 0,58899415 &\\
	Шк. экономики (УФУ) & gsem.urfu.ru & 0,60790914 & \checkmark\\
	Гуманитарный (УФУ) & igniurfu.ru & 0,614657 &\\
	Шк. философии (ВШЭ) & phil.hse.ru & 0,6320924 & \checkmark\\
	Физика (ТГУ) & ff.tsu.ru & 0,63752955 &\\
	Естественных наук (УФУ) & ins.urfu.ru & 0,64553267 &\\
	Социологический (ВШЭ) & social.hse.ru & 0,6517592 &\\
	Юридический (ТГУ) & ul.tsu.ru & 0,66601765 & \checkmark\\
	Искусств и культуры (ТГУ) & itk.tsu.ru & 0,68442845 & \checkmark\\
	ПМ-ПУ (СПбГУ) & apmath.spbu.ru & 0,6961114 &\\
	Политология (МГУ) & polit.msu.ru & 0,7173793 & \checkmark\\
	Мир. политика (МГУ) & fmp.msu.ru & 0,72291535 & \checkmark\\
	Математика (ВШЭ) & math.hse.ru & 0,7243976 &\\
	Мат.-мех. (СПбГУ) & math.spbu.ru & 0,72852707 &\\
	Искусств (СПбГУ) & arts.spbu.ru & 0,84609234 &\\
	Исторический (ТГУ) & if .tsu.ru & 0,8502206 &\\
	Иностр. языков (ТГУ) & fif.tsu.ru & 0,91516674 &\\
	\bottomrule
\end{longtblr}

Каждый сайт проанализирован с помощью специализированного поискового робота, к которому был подключен модуль сбора и обработки данных, необходимых для вычисления параметров степенной функции. Среди обработанных 38 сайтов 13 сайтов были забракованы ввиду малого числа расположенных на них гиперссылок (меньше 5000 ссылок). К полученным данным (см. таблицу~\cref{tab:departmentSitesClusteringResults}) была применена процедура ручной кластеризации по параметру \(\beta\).

\begin{table}[ht]%
	\centering
	\caption{Результаты кластеризации сайтов подразделений}%
	\label{tab:departmentSitesClusteringResults}% label всегда желательно идти после caption
	\begin{adjustbox}{width=1\textwidth}
		...
		\begin{tabular}{ c  c  c  }% Вертикальные полосы не используются принципиально, как и лишние горизонтальные (допускается по ГОСТ 2.105 пункт 4.4.5) % @{} позволяет прижиматься к краям
			\toprule
			Подразделение & Параметр & Номер кластера\\
			\hline
			Политология (СПбГУ) & 0,23070328 & 1\\
			Экономический (МГУ) & 0,36471105 & 2\\
			Радиоэлектроника (УФУ) & 0,37494412 & 2\\
			Гос. управление (МГУ) & 0,38630083 & 2\\
			Международных отношений (ТГУ) & 0,39907148 & 2\\
			В. инж. школа (УФУ) & 0,40382472 & 2\\
			Исторический (ВШЭ) & 0,5106529 & 3\\
			Филологический (ТГУ) & 0,5208593 & 3\\
			Иностр. языков (МГУ) & 0,5229387 & 3\\
			Искусств (МГУ) & 0,5240312 & 3\\
			Лингвистики (ВШЭ) & 0,52746964 & 3\\
			Филологический (СПбГУ) & 0,53078467 & 3\\
			Соц. и полит. наук (УФУ) & 0,568136 & 4\\
			Исторический (СПбГУ) & 0,57104033 & 4\\
			Юридический (СПбГУ) & 0,58899415 & 4\\
			Гуманитарный (УФУ) & 0,614697 & 4\\
			Физика (ТГУ) & 0,63752955 & 5\\
			Естественных наук (УФУ) & 0,64553267 & 5\\
			Социологический (ВШЭ) & 0,6517592 & 5\\
			ПМ-ПУ (СПбГУ) & 0,6961114 & 5\\
			Математика (ВШЭ) & 0,7243976 & 5\\
			Мат.-мех. (СПбГУ) & 0,72852707 & 5\\
			Искусств (СПбГУ) & 0,84609234 & 6\\
			Исторический (ТГУ) & 0,8502206 & 6\\
			Иностр. языков (ТГУ) & 0,91516674 & 6\\
			\bottomrule
		\end{tabular}%
	\end{adjustbox}
\end{table}

\paragraph{3. Результаты.} Результаты эксперимента приведены в таблицах~\cref{tab:departmentSitesResearchResults},~\cref{tab:departmentSitesClusteringResults}. Университеты, которым принадлежат подразделения, указаны в скобках с помощью аббревиатур. Данные отсортированы по параметру \(\beta\). Таблица~\cref{tab:departmentSitesResearchResults} содержит результаты сбора данных и построения аппроксимирующих функций (параметр а опущен, так как представляет собой некоторый масштабный множитель, не определяющий кривизну графика функции, а больше зависящий от объема рассматриваемого веб-сайта). Таблица~\cref{tab:departmentSitesClusteringResults} отображает результаты кластеризации на сайтах факультетов, которые содержат достаточное количество гиперссылок.

\paragraph{4. Выводы.} По результатам эксперимента можно выделить две четкие группы сайтов научно-учебных подразделений исследуемых университетов: группа естественных наук (с интервалом параметра степенной функции 0,63"---0,73) и группа гуманитарных наук (с интервалом параметра степенной функции 0,51"---0,61).

Таким образом, параметр 3, по-видимому, может быть использован для предварительного определения тематической направленности сайта.
