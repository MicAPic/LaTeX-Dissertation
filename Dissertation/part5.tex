...
%		\hline
%		\multicolumn{6}{c}{\makecell{Note. Highlighted: local; red: new; grey: news; black: previously mentioned issues}}\\
%		\bottomrule %%% нижняя линейка
%	\end{longtable}
%\end{table}
...
\begin{longtblr}[
	caption = {Agendas in the sub-datasets, first 50 summarizations of January 07 (English and French)/full list (German)},
	label = {tab:subDatasetAgendas},
	remark{Note} = {Highlighted: local; red: new; grey: news; black: previously mentioned issues.},
	]{
		colspec = {XXXXXX}, 
		width = 1.0\linewidth,
		rowhead = 1,
